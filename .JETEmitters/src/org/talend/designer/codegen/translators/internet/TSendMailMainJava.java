...
public class TSendMailMainJava
{
  ...
  protected final String TEXT_172 = ");" + NL + "\t\t// add com.sun.mail.handlers to job imports / depenencies (TESB-27110)" + NL + "\t\tcom.sun.mail.handlers.text_plain text_plain_h_";
  protected final String TEXT_173 = " = null;" + NL + "\t\t// -- Send the message --" + NL + "\t\tjavax.mail.Transport.send(msg_";
  protected final String TEXT_174 = ");" + NL + "\t} catch(java.lang.Exception e){" + NL + "  \t\t";
  protected final String TEXT_175 = NL + "\t\t\tthrow(e);" + NL + "\t\t";
  protected final String TEXT_176 = NL + "\t\t\t";
  protected final String TEXT_177 = NL + "\t\t\t\tlog.error(\"";
  protected final String TEXT_178 = " - \" + e.toString());" + NL + "\t\t\t";
  protected final String TEXT_179 = NL + "  \t\t\tSystem.err.println(e.toString());" + NL + "\t\t";
  protected final String TEXT_180 = NL + "\t}finally{" + NL + "\t\tprops_";
  protected final String TEXT_181 = ".remove(\"mail.smtp.host\");" + NL + "\t\tprops_";
  protected final String TEXT_182 = ".remove(\"mail.smtp.port\");" + NL + "\t\t";
  protected final String TEXT_183 = ".remove(\"mail.smtp.localhost\");" + NL + "\t\t";
  protected final String TEXT_184 = ".remove(\"mail.mime.encodefilename\");" + NL + "\t\t";
  protected final String TEXT_185 = ".remove(\"mail.smtp.starttls.enable\");" + NL + "\t\t";
  protected final String TEXT_186 = ".remove(\"mail.smtp.socketFactory.class\");" + NL + "\t\t\tprops_";
  protected final String TEXT_187 = ".remove(\"mail.smtp.socketFactory.fallback\");" + NL + "\t\t\tprops_";
  protected final String TEXT_188 = ".remove(\"mail.smtp.socketFactory.port\");" + NL + "\t\t";
  protected final String TEXT_189 = ".remove(\"mail.smtp.auth\");     " + NL + "\t}";
