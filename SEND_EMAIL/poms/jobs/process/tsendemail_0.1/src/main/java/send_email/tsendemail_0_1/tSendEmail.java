...
package send_email.tsendemail_0_1;
 ...
 * @status
 */
public class tSendEmail implements TalendJob {
	...
	private final String jobName = "tSendEmail";
	private final String projectName = "SEND_EMAIL";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(tSendEmail.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public void tSendMail_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String from_tSendMail_1 = ("talend493493@gmail.com");
				String to_tSendMail_1 = ("tjorge493493@gmail.com").replace(";", ",");
				String cc_tSendMail_1 = (("") == null || "".equals("")) ? null : ("").replace(";", ",");
				String bcc_tSendMail_1 = (("") == null || "".equals("")) ? null : ("").replace(";", ",");
				String subject_tSendMail_1 = ("TOS Mail System");
							...
							new javax.mail.Authenticator() {
								protected javax.mail.PasswordAuthentication getPasswordAuthentication() {
									...
									final String decryptedPassword_tSendMail_1 = routines.system.PasswordEncryptUtil
											.decryptPassword(
													"enc:routine.encryption.key.v1:Gj7E60eCkTT1LxaGvuJ3qp9xC2py9DUUg8n3lY47vSVtkapu9w==");

									return new javax.mail.PasswordAuthentication("talend493493@gmail.com",
	...
	public static void main(String[] args) {
		final tSendEmail tSendEmailClass = new tSendEmail();

		int exitCode = tSendEmailClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = tSendEmail.class.getClassLoader()
					.getResourceAsStream("send_email/tsendemail_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = tSendEmail.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : tSendEmail");
		}
...
/************************************************************************************************
 * 31155 characters generated by Talend Open Studio for ESB on the 13 de Abril
 * de 2021 15h39min55s BRT
 ************************************************************************************************/